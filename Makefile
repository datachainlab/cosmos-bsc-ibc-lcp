...
BSC_WASM_CODE=./ibc-elc-client-cw/target/wasm32-unknown-unknown/release/ibc_parlia_client_cw.wasm
...
$(BSC_WASM_CODE):
	cd ./ibc-elc-client-cw && BSC_BLOCKS_PER_EPOCH=20 cargo wasm -p ibc-parlia-client-cw
